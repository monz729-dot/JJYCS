...
public class OrdersController {
    ...
    public ResponseEntity<ApiResponse<OrderResponse>> createOrder(
        ...
        try {
            OrderResponse order = orderService.createOrder(request, userPrincipal.getUserId());
    ...
    public ResponseEntity<ApiResponse<OrderResponse>> getOrder(
        ...
        log.info("Getting order {} for user: {}", orderId, userPrincipal.getUserId());
    ...
    public ResponseEntity<ApiResponse<OrderResponse>> updateOrder(
        ...
        log.info("Updating order {} for user: {}", orderId, userPrincipal.getUserId());
        
        try {
            OrderResponse order = orderService.updateOrder(orderId, request, userPrincipal.getUserId());
    ...
    public ResponseEntity<ApiResponse<OrderResponse>> updateOrderStatus(
        ...
        log.info("Updating order {} status to {} by user: {}", 
                orderId, request.getStatus(), userPrincipal.getUserId());
        
        try {
            OrderResponse order = orderService.updateOrderStatus(orderId, request, userPrincipal.getUserId());
    ...
    public ResponseEntity<ApiResponse<OrderResponse>> cancelOrder(
        ...
        try {
            OrderResponse order = orderService.cancelOrder(orderId, request, userPrincipal.getUserId());
    ...
    public ResponseEntity<ApiResponse<BusinessRuleValidationResponse>> validateBusinessRules(
        ...
        log.info("Validating business rules for user: {}", userPrincipal.getUserId());
        
        try {
            BusinessRuleValidationResponse response = 
                orderService.validateBusinessRules(request, userPrincipal.getUserId());
            return ResponseEntity.ok(ApiResponse.success(response));
...
// UserPrincipal 클래스 (Spring Security 용)
class UserPrincipal {
    private Long userId;
    private String role;
