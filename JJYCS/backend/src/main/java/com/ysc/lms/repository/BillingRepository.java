...
public interface BillingRepository extends JpaRepository<Billing, Long> {
    ...
    /**
     * P0-3: 사용자별 미결제 청구서 조회
     */
    @Query("SELECT b FROM Billing b JOIN b.order o WHERE o.user.id = :userId " +
           "AND b.paymentStatus = 'PENDING' AND b.proformaIssued = true " +
           "ORDER BY b.proformaDate ASC")
    List<Billing> findPendingBillingsByUserId(@Param("userId") Long userId);
