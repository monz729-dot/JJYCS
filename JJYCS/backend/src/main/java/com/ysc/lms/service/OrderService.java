...
public class OrderService {
    ...
    public Order createOrderEntities(CreateOrderRequest request) {
        ...
        // 리팩 옵션 확인
        boolean hasRepackOption = request.getRepackingRequested() != null && request.getRepackingRequested();
        
        // 주문코드 자동 생성 (새로운 규칙 적용)
        String orderCode = codeGenerationService.generateOrderCode(shippingType, hasRepackOption, user.getMemberCode());
    ...
    public static class CreateOrderRequest {
        ...
        private Boolean repackingRequested = false; // 리패킹 요청 여부
        @JsonProperty("items")
        ...
        public Boolean getRepackingRequested() { return repackingRequested; }
        public void setRepackingRequested(Boolean repackingRequested) { this.repackingRequested = repackingRequested; }
